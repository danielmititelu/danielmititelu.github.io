import{S as yn,i as bn,s as _n,e as p,t as i,k as l,c as e,a as o,h as r,d as s,m as u,b as h,g as t,F as c,G as Z}from"../../chunks/vendor-cac58433.js";function vn(mn){let k,W,D,_,z,A,v,B,I,E,J,C,f,hn=`<code class="language-cs"><span class="token comment">// Dutch national flag problem (partition array into 3 parts: red, white, blue)</span>
...
<span class="token punctuation">&#125;</span></code>`,R,g,K,q,w,fn=`<code class="language-cs"><span class="token comment">// Function to partition the array around the range such </span>
...
<span class="token punctuation">&#125;</span></code>`,F,P,N,M,L,T,d,O,U,S,Q,j,m,H,y,V,X,x,b,Y;return{c(){k=p("h1"),W=i("Three way partitioning"),D=l(),_=p("p"),z=i("A partition strategy that is sometime used in quicksort."),A=l(),v=p("h2"),B=i("Code example"),I=l(),E=p("h3"),J=i("Dutch national flag problem"),C=l(),f=p("pre"),R=l(),g=p("h3"),K=i("Partition around a range"),q=l(),w=p("pre"),F=l(),P=p("h2"),N=i("References"),M=l(),L=p("ul"),T=p("li"),d=p("a"),O=i("https://en.wikipedia.org/wiki/Dutch_national_flag_problem#Pseudocode"),U=l(),S=p("h2"),Q=i("Problems"),j=l(),m=p("ul"),H=p("li"),y=p("a"),V=i("https://leetcode.com/problems/sort-colors/"),X=l(),x=p("li"),b=p("a"),Y=i("https://practice.geeksforgeeks.org/problems/three-way-partitioning/1/#"),this.h()},l(n){k=e(n,"H1",{});var a=o(k);W=r(a,"Three way partitioning"),a.forEach(s),D=u(n),_=e(n,"P",{});var $=o(_);z=r($,"A partition strategy that is sometime used in quicksort."),$.forEach(s),A=u(n),v=e(n,"H2",{});var nn=o(v);B=r(nn,"Code example"),nn.forEach(s),I=u(n),E=e(n,"H3",{});var sn=o(E);J=r(sn,"Dutch national flag problem"),sn.forEach(s),C=u(n),f=e(n,"PRE",{class:!0});var wn=o(f);wn.forEach(s),R=u(n),g=e(n,"H3",{});var an=o(g);K=r(an,"Partition around a range"),an.forEach(s),q=u(n),w=e(n,"PRE",{class:!0});var dn=o(w);dn.forEach(s),F=u(n),P=e(n,"H2",{});var tn=o(P);N=r(tn,"References"),tn.forEach(s),M=u(n),L=e(n,"UL",{});var pn=o(L);T=e(pn,"LI",{});var en=o(T);d=e(en,"A",{href:!0,rel:!0});var on=o(d);O=r(on,"https://en.wikipedia.org/wiki/Dutch_national_flag_problem#Pseudocode"),on.forEach(s),en.forEach(s),pn.forEach(s),U=u(n),S=e(n,"H2",{});var cn=o(S);Q=r(cn,"Problems"),cn.forEach(s),j=u(n),m=e(n,"UL",{});var G=o(m);H=e(G,"LI",{});var ln=o(H);y=e(ln,"A",{href:!0,rel:!0});var un=o(y);V=r(un,"https://leetcode.com/problems/sort-colors/"),un.forEach(s),ln.forEach(s),X=u(G),x=e(G,"LI",{});var rn=o(x);b=e(rn,"A",{href:!0,rel:!0});var kn=o(b);Y=r(kn,"https://practice.geeksforgeeks.org/problems/three-way-partitioning/1/#"),kn.forEach(s),rn.forEach(s),G.forEach(s),this.h()},h(){h(f,"class","language-cs"),h(w,"class","language-cs"),h(d,"href","https://en.wikipedia.org/wiki/Dutch_national_flag_problem#Pseudocode"),h(d,"rel","nofollow"),h(y,"href","https://leetcode.com/problems/sort-colors/"),h(y,"rel","nofollow"),h(b,"href","https://practice.geeksforgeeks.org/problems/three-way-partitioning/1/#"),h(b,"rel","nofollow")},m(n,a){t(n,k,a),c(k,W),t(n,D,a),t(n,_,a),c(_,z),t(n,A,a),t(n,v,a),c(v,B),t(n,I,a),t(n,E,a),c(E,J),t(n,C,a),t(n,f,a),f.innerHTML=hn,t(n,R,a),t(n,g,a),c(g,K),t(n,q,a),t(n,w,a),w.innerHTML=fn,t(n,F,a),t(n,P,a),c(P,N),t(n,M,a),t(n,L,a),c(L,T),c(T,d),c(d,O),t(n,U,a),t(n,S,a),c(S,Q),t(n,j,a),t(n,m,a),c(m,H),c(H,y),c(y,V),c(m,X),c(m,x),c(x,b),c(b,Y)},p:Z,i:Z,o:Z,d(n){n&&s(k),n&&s(D),n&&s(_),n&&s(A),n&&s(v),n&&s(I),n&&s(E),n&&s(C),n&&s(f),n&&s(R),n&&s(g),n&&s(q),n&&s(w),n&&s(F),n&&s(P),n&&s(M),n&&s(L),n&&s(U),n&&s(S),n&&s(j),n&&s(m)}}}const gn={title:"Three way partitioning"};class Pn extends yn{constructor(k){super();bn(this,k,null,vn,_n,{})}}export{Pn as default,gn as metadata};
